...
# Single source of truth for the server version (used by /version and tests).
__version__ = "26.9"

def _mask_secret(value: str | None) -> str:
    """Return a masked view of a credential for safe logging (never log the raw value)."""
    if not value:
        return '<unset>'
    if len(value) <= 4:
        return '****'
...
def register_tools() -> None:
    ...
    @mcp.tool(description="Upload file content (provided as a Base64 string) to Aspose Cloud Storage and return a file_uuid. The file is stored in its own uuid folder: when file_name is given the file keeps that name (folder = uuid, name = file_name, e.g. <uuid>/report.xlsx); when file_name is empty a default name is used. Later calls address the file via the returned file_uuid regardless of the name.")
    def upload_file(file_content_b64string: str, file_name: str = None):
        """
        ...
        Parameters:
        - file_content_b64string: The content of the file encoded as a Base64 string. Do not pass a file path here.
        - file_name: Optional original file name; when provided the file is created under this name inside its uuid folder, otherwise a default name is used.

        Returns:
        - The file_uuid assigned to the uploaded file.
         """
        return core.io.upload_file(file_content_b64string, file_name)

    @mcp.tool(description="Download the file identified by the given file_uuid and return its contents as a Base64-encoded string.",)
    def download_file(file_uuid: str):
        ...
        Parameters:
        - file_uuid: The unique identifier of the document.

        Returns:
        - The content of the file encoded as a Base64 string.
         """
        return core.io.download_file(file_uuid)
    ...
    def save_spreadsheet_as( file_uuid :str, target_format:str):
        """
        ...
        Returns:
        - The file_uuid of the converted file.
         """
        return core.convert.save_spreadsheet_as(file_uuid,target_format)

    @mcp.tool(
        description="Extract the full structure of a spreadsheet stored in Aspose Cloud Storage as a JSON document: workbook metadata, worksheets, tables (with column formulas), pivot tables, charts, and shape coordinates. Call this to inspect a workbook before editing or converting. Redundant empty nodes are omitted.")
    def get_structure_with_file_uuid(file_uuid: str)->str:
        ...
        - The spreadsheet structure.Standard JObject JSON object containing hierarchical structured data: workbook root information, worksheet collection, and nested sub-modules of tables (with column formulas), pivot tables, charts and shape coordinate attributes. Redundant empty nodes are automatically omitted.
         """
        return core.management.get_structure_with_file_uuid(file_uuid)

    @mcp.tool(
        description="Extract the full structure of a spreadsheet (provided as a Base64 string) as a JSON document: workbook metadata, worksheets, tables (with column formulas), pivot tables, charts, and shape coordinates. Call this to inspect a workbook before editing or converting. Redundant empty nodes are omitted.")
    ...
    def save_spreadsheet_as_with_save_options_json_data( file_uuid :str, target_format:str,save_options_json_data :str):
        """
        ...
        - The file_uuid of the converted file.
         """
        return core.convert.save_spreadsheet_as_with_save_options_json_data(file_uuid,target_format,save_options_json_data)
    ...
    def trim_text(file_uuid: str,worksheet:str = None ,_range:str = None,trim_text:str = ' ')->bool:
        """
        ...
        :param file_uuid (str ):  Unique identifier of the target Excel file in Aspose.Cells Cloud storage(require).
        ...
        :param trim_text (str, optional): Character(s) to strip from both the beginning and the end of each text cell. Defaults to a single space character (' ').
        :return: True if the operation succeeds.
        """
        return core.edit.trim_text(file_uuid,worksheet,_range,trim_text)
    ...
    def trim_text_from_leading(file_uuid: str,worksheet:str = None ,_range:str = None,trim_text:str = ' ')->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.trim_text_from_leading(file_uuid,worksheet,_range,trim_text)
    ...
    def trim_text_from_trailing(file_uuid: str,worksheet:str = None ,_range:str = None,trim_text:str = ' ')->bool:
        """
        Removes specified trailing characters from the end of text values in a worksheet range. This function uses Aspose.Cells Cloud API to process an Excel file and trim unwanted characters only from the end (right side) of each cell's text content. Unlike trim_text(), this does NOT remove leading characters. It is ideal for cleaning data with consistent suffixes like extra spaces, line-ending markers, or special characters at the end of cells.

        :param file_uuid (str ):  Unique identifier of the target Excel file in Aspose.Cells Cloud storage(require).
        :param worksheet (str, optional): Name of the worksheet (case-sensitive) where the cells reside. If None or empty string, the operation applies to the first worksheet. Defaults to None.
        :param _range (str, optional): Target cell range in standard A1 notation (e.g., "A1:B10") or a named range. Supports single cells, contiguous blocks, or entire columns/rows. If None or empty string, applies to all used (non-empty) cells in the worksheet. Defaults to None.
        :param trim_text (str, optional): Character(s) to strip from the end of each text cell only. Defaults to a single space character (' ')..
        :return: True if the operation succeeds.
        """
        return core.edit.trim_text_from_trailing(file_uuid,worksheet,_range,trim_text)
    ...
    def remove_extra_line_breaks(file_uuid: str,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_extra_line_breaks(file_uuid,worksheet,_range)
    ...
    def remove_all_line_breaks(file_uuid: str,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_all_line_breaks(file_uuid,worksheet,_range)
    ...
    def word_case(file_uuid: str,worksheet:str = None ,_range:str = None, word_case_type:str = 'UpperCase')->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.word_case(file_uuid,worksheet,_range,word_case_type)
    ...
    def remove_non_printing_characters(file_uuid: str,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_non_printing_characters(file_uuid,worksheet,_range)
    ...
    def remove_text_characters(file_uuid: str,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_text_characters(file_uuid,worksheet,_range)
    ...
    def remove_numeric_characters(file_uuid: str,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_numeric_characters(file_uuid,worksheet,_range)
    ...
    def remove_symbols(file_uuid: str,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_symbols(file_uuid,worksheet,_range)
    ...
    def remove_punctuation_marks(file_uuid: str,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_punctuation_marks(file_uuid,worksheet,_range)
    ...
    def remove_custom_characters(file_uuid: str,custom_characters:str, worksheet:str = None ,_range:str = None, case_sensitive:bool = False)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_custom_characters(file_uuid,worksheet,_range,custom_characters,case_sensitive )
    ...
    def remove_first_n_characters(file_uuid: str, number:int,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_first_n_characters(file_uuid,worksheet,_range, number)
    ...
    def remove_last_n_characters(file_uuid: str, number:int,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.remove_last_n_characters(file_uuid,worksheet,_range, number)
    ...
    def remove_before_text(file_uuid: str, text:str, worksheet:str = None ,_range:str = None,  case_sensitive:bool = False)->bool:
        """
        ...
        :param file_uuid (str ):  Unique identifier of the target Excel file in Aspose.Cells Cloud storage(require).
        :param text (str): Delimiter text that marks the boundary. All characters before the first occurrence of this text (left side) will be removed. If the delimiter is not found, the cell remains unchanged.
        :param worksheet (str, optional): Name of the worksheet (case-sensitive) where the cells reside. If None or empty string, the operation applies to the first worksheet. Defaults to None.
        :param _range (str, optional): Target cell range in standard A1 notation (e.g., "A1:B10") or a named range. Supports single cells, contiguous blocks, or entire columns/rows. If None or empty string, applies to all used (non-empty) cells in the worksheet. Defaults to None.
        :param case_sensitive (str, optional): Controls case sensitivity for letter removal. Defaults to False.
        :return: True if the operation succeeds.
        """
        return core.edit.remove_before_text(file_uuid,worksheet,_range, text,case_sensitive)
    ...
    def remove_after_text(file_uuid: str, text:str, worksheet:str = None ,_range:str = None,  case_sensitive:bool = False)->bool:
        """
        Removes all characters after (to the right of) a specified delimiter text in each text cell. This function uses Aspose.Cells Cloud API to process an Excel file and delete everything that appears after a specific delimiter string within each text cell. The delimiter text itself is kept and becomes the new end of the string. This is useful for extracting data before a specific marker, removing suffixes, cleaning log entries, parsing structured text, or isolating relevant portions of strings.

        :param file_uuid (str ):  Unique identifier of the target Excel file in Aspose.Cells Cloud storage(require).
        :param text (str): Delimiter text that marks the boundary. All characters after the first occurrence of this text (right side) will be removed. If the delimiter is not found, the cell remains unchanged.
        :param worksheet (str, optional): Name of the worksheet (case-sensitive) where the cells reside. If None or empty string, the operation applies to the first worksheet. Defaults to None.
        :param _range (str, optional): Target cell range in standard A1 notation (e.g., "A1:B10") or a named range. Supports single cells, contiguous blocks, or entire columns/rows. If None or empty string, applies to all used (non-empty) cells in the worksheet. Defaults to None.
        :param case_sensitive (str, optional): Controls case sensitivity for letter removal. Defaults to False.
        :return: True if the operation succeeds.
        """
        return core.edit.remove_after_text(file_uuid,worksheet,_range, text,case_sensitive)
    ...
    def add_text_at_head(file_uuid: str, text:str, worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.add_text_at_head(file_uuid,worksheet,_range, text)
    ...
    def add_text_at_tail(file_uuid: str, text:str, worksheet:str = None ,_range:str = None)->bool:
        """
        Adds specified text to the end (tail) of each text cell in the specified range. This function uses Aspose.Cells Cloud API to process an Excel file and append a user-specified string to the end of every text cell within the target range. The original cell content is preserved and the new text is added after it. This is useful for adding suffixes, units, labels, identifiers, or any consistent text that should appear at the end of cell values.
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.add_text_at_tail(file_uuid,worksheet,_range, text)
    ...
    def add_text_before_text(file_uuid: str, text:str,select_text:str, worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.add_text_before_text(file_uuid,worksheet,_range, text,select_text)
    ...
    def add_text_after_text(file_uuid: str, text:str,select_text:str, worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :param select_text (str): Target delimiter or selector text that marks the insertion point. The new text will be placed immediately after the first occurrence of this string.
        :param worksheet (str, optional): Name of the worksheet (case-sensitive) where the cells reside. If None or empty string, the operation applies to the first worksheet. Defaults to None.
        :param _range (str, optional): Target cell range in standard A1 notation (e.g., "A1:B10") or a named range. Supports single cells, contiguous blocks, or entire columns/rows. If None or empty string, applies to all used (non-empty) cells in the worksheet. Defaults to None.
        :return: True if the operation succeeds.
        """
        return core.edit.add_text_after_text(file_uuid,worksheet,_range, text,select_text)
    ...
    def convert_number_to_text(file_uuid: str,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.convert_number_to_text(file_uuid,worksheet,_range)
    ...
    def convert_line_break_to_text(file_uuid: str,target_text:str,worksheet:str = None ,_range:str = None)->bool:
        """
        ...
        :return: True if the operation succeeds.
        """
        return core.edit.convert_line_break_to_text(file_uuid,worksheet,_range,target_text)

def run_server(transport: str | None=None, host: str='0.0.0.0', port: int=8080, path: str='/mcp',
    ...
    # Never log raw credentials; only masked values.
    logger.info('Cloud credentials configured: client_id=%s client_secret=%s',
                _mask_secret(os.getenv('ASPOSE_CLOUD_CLIENT_ID')),
                _mask_secret(os.getenv('ASPOSE_CLOUD_CLIENT_SECRET')))
    ...
    if tr in {'streamable-http', 'sse'}:
        # Anonymous access only: the former MCP_AUTH_TOKEN bearer-authentication
        # feature was removed, so every HTTP request (including /health, /version
        # and the MCP endpoints) is served without credentials.
        path_for_tr = path_sse_env if tr == 'sse' else path_http_env
        logger.info('Listening on http://%s:%s%s (%s). No authentication configured — '
                    'endpoints are open (anonymous access).', host_env, port_env, path_for_tr, tr)
